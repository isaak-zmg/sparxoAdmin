...
@observer
export default class FRCADetails extends React.Component{
  constructor(props){
    super(props)
    this.columns = [
      {
      ...
      },
      {
        ...
        render: (text,record,index) =>{
          const { fr_Details } = this.props.languageStore
          return (
            <Input type="textarea"
  ...
  save = () => {
    ...
    var temp = toJS(languageStore.fr_Details);
    var postData = {};
    for (var s in temp) {
  ...
  render() {
    ...
    let datasource = toJS(fr_Details);
